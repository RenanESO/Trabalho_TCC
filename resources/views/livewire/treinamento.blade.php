                            ...
                            <div class="card-body text-black">
                                ...
                                <form wire:submit.prevent="buscarImagem">
                                    ...
                                    @if ($image_pessoa_treinamento)
                                        <img src="{{ $image_pessoa_treinamento->temporaryUrl() }}" width="400" height="400">
                                    @endif
                                </form>
                                <!-- Fim :: Buscar Imagem -->
                    ...
                    <div class="col-lg mx-auto m-2">
                        ...
                        <div class="card shadow-sm">
                            ...
                            <div class="card-body text-black">
                                ...
                                <form class="col-lg mx-auto m-2" wire:submit.prevent="cadastrarPessoa" wire:confirm="Deseja realmente cadastrar essa Pessoa?">
                                    <div class="input-group mb-3">
                                        <span class="input-group-text">Nome:</span>
                                        <input class="form-control" type="text" placeholder="Nova Pessoa" wire:model="nome_pessoa_cadastro" required>
                            ...
                            <div class="card-body text-black">
                                ...
                                <div class="col-lg mx-auto m-2">
                                    <div class="input-group mb-3">                   
                                        ...
                                        <input class="form-control" type="search" placeholder="Pessoa" wire:model="query_pessoas_cadastro" aria-label="Search" wire:input.debounce.300ms="reiniciarPaginacao">           
                                    </div> 
                                </div>
                                        ...
                                        <tr class="list-group-item d-flex align-items-center">
                                                ...
                                                <td class="p-2"> 
                                                    @if ($pessoa->rostos->isNotEmpty())
                                                        <img class="img-pessoa" src="{{ asset('storage/' . $pessoa->rostos[0]->url_rosto) }}" alt={{ $pessoa->nome }} width="150" height="150">
                                                    @else
